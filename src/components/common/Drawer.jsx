	...
	return (
		<>
			...
			<div className={`relative z-40 flex flex-row w-full max-w-[450px] h-full ${isOpen ? 'translate-x-0' : '-translate-x-full'} ease-in-out transition-transform duration-350`}>
				<Scrollbars universal className={`w-[450px] max-w-[450px] h-full bg-[#D0F8F9]/60 backdrop-brightness-125 backdrop-blur-lg ${isOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300`}>
